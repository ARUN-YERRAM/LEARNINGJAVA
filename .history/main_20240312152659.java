...
// Data types :  
// primitive ,built in ----- hold single values,cannot be divided... ---- boolean,char,byte,short,int,long.float,
// Non primitive ---- user defined, memory address of a variable,  complex   
